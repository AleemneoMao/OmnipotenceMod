    ...
    public class Human_o
    {
        public class Mod : UserMod2// 官方接口，游戏运行时加载harmony补丁，修改复制人默认参数
        {
            public override void OnLoad(Harmony harmony)
            {
                ...
                Traverse.Create(typeof(DUPLICANTSTATS.ATTRIBUTE_LEVELING)).Field<int>("MAX_GAINED_ATTRIBUTE_LEVEL").Value = 60;// 最大等级80级
        ...
        [HarmonyPatch(typeof(Database.AttributeConverters), MethodType.Constructor)]
        public class Patch_AttributeConverters
        {
            public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instr)// 小人属性加成修改
            {
